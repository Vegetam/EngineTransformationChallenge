package com.francescomalagrino.tfl.logs;
...
public class ServiceLogger {
    ...
    @Before("execution(* com.francescomalagrino.tfl.service.TflApiService.searchTrains(..)) && args(platformId)")
    public void beforeSearch(String platformId) {
        LOGGER.info("Received a request for searching:" + platformId);
    }

    @AfterReturning(pointcut = "execution(* com.francescomalagrino.tfl.service.TflApiService.searchTrains(..))", returning = "result")
